...
:TEST4
echo running driver sample test 3
call Run-test.cmd 0 "" %output_folder%\test3.txt driver_sample_test3.cpp PRNG.cpp %user_files%
IF %RETURNVALUE% neq 0 ( GOTO FAIL ) ELSE ( GOTO PASS )
