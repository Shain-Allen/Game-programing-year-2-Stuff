...
void Dump(const CS175::WarBoats::Ocean &ocean, int field_width = 4, bool extraline = false, bool showboats = true)
{
...
void PrintStats(const CS175::WarBoats::Ocean &ocean)
{
  CS175::WarBoats::ShotStats stats = ocean.GetShotStats();
...
void test0(void)
{
  ...
  int xsize = 8;
  int ysize = 8;
  CS175::WarBoats::Ocean ocean(num_boats, xsize, ysize);
...
void test2(void)
{
  ...
  CS175::WarBoats::Ocean *ocean;
  ocean = new CS175::WarBoats::Ocean(num_boats, xsize, ysize);
